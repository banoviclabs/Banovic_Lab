...
### Thank you for visiting the Banovic Lab Website: a research lab in the [Small Animal Medicine and Surgery (SAMS) department of the University of Georgia (UGA) College of Veterinary Medicine (CVM)](https://vet.uga.edu/education/academic-departments/small-animal-medicine-and-surgery/) in Athens Georgia, USA
<br>
...
#### Specifically, this lab examines dermatological diseases and the changes in immunological pathways causing inflammation, itch, and other symptoms. Especially, we try to understand the core molecular pathways causing symptomatic flare ups that become chronic in their nature and define the disease. These pathways can be treated with more targeted therapies when they are better understood, allowing greater relief of symptoms with fewer negative side effects. We do this using a number of techniques, discussed on the laboratory techniques page.
